...
class cliente_model extends CI_Model {
	...
	PUBLIC function  get_cliente(){
		$this->db->select('e.id_cliente, e.nombre, e.apellido, e.correo,s.nombre_sexo, e.telefono, e.direccion, p.nombre_departamento , e.usuario, e.clave, r.nombre_rol');
		$this->db->from('usuario e');
		$this->db->join('departamento p', 'p.id_departamento  = e.id_departamento ');
