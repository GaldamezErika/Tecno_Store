...
<?php $this->load->helper('validacionescliente') ?>
      ...
      <div class="row">
       ...
       <div class="card shadow mb-4">
        <div class="card-body d-flex justify-content-between align-items-center">
          <button type="button" class="btn btn-primary" style="float: right;" id="nuevocliente"><i class='fa fa-th-list'></i>
            Nuevo Cliente
          </button>
          <h2>Clientes</h2>
        </div>
...
<div class="modal fade" id="cliente" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <form id="formcliente" action="" method="POST" class="mx-auto">
        <div class="modal-header">
        ...
        <div class="modal-body">
          ...
          <div class="col">
            <div class="input-group">
              ...
              <select name="departamento" id="departamento" class="form-control" aria-label="Small" aria-describedby="inputGroup-sizing-sm">
                <option value="">Seleccione departamento</option>
              </select>
            </div>
          </div>
          <br>
          <div class="col" id="usu">
            <div class="input-group">
